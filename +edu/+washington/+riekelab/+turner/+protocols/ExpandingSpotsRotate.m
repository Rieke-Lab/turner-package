classdef ExpandingSpotsRotate < edu.washington.riekelab.protocols.RiekeLabStageProtocol
% EXPANDINGSPOTS
%
% From turner-package
%
...
% -------------------------------------------------------------------------    
    properties
        ...
        spotSizes = [50 100 150 200 225 250 300 450 600 900] % um
        randomizeOrder = false
        backgroundIntensity = 0.5 % (0-1)
        centerOffset = [0, 0] % [x,y] (um)
        onlineAnalysis = 'none'
        numberOfAverages = uint16(3) % number of averages to queue
    ...
    methods
        ...
        function tf = shouldContinuePreparingEpochs(obj)
            ...
            tf = obj.numEpochsPrepared < obj.numberOfAverages * length(obj.spotSizeSequence);
        end
