classdef LinearEquivalentDiscConeLin < edu.washington.riekelab.turner.protocols.NaturalImageFlashProtocol
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            if ~strcmp(obj.onlineAnalysis, 'none')
                obj.showFigure('edu.washington.riekelab.turner.figures.ImageVsIntensityConeLinFigure', ...
        ...
        function prepareEpoch(obj, epoch)
            ...
            if ~obj.linearizeCones
                ...
                elseif stimInd == 0
                    ...
                    obj.stimulusTag = 'linConeIntensity';
                end
            end
        ...
        function p = createPresentation(obj)
            ...
            elseif strcmp(obj.stimulusTag, 'linConeIntensity')
                scene = stage.builtin.stimuli.Rectangle();
                scene.size = canvasSize;
                ...
                error('Unknown stimulusTag: %s', obj.stimulusTag);
            end
